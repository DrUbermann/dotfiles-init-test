...
"@ | Out-File -FilePath $tmpScript -Encoding ASCII
    ...
    Start-Process powershell.exe -Verb RunAs -Wait -WorkingDirectory $env:SystemRoot -ArgumentList "-NoProfile", "-ExecutionPolicy", "Bypass", "-File", $tmpScript #-WindowStyle Hidden
