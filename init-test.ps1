...
"@ | Out-File -FilePath $tmpScript -Encoding ASCII
    ...
    Start-Process powershell.exe -Wait -ArgumentList "-NoProfile", "-ExecutionPolicy", "Bypass", "-File", "C:\Users\Alexander\Documents\ApplyBindings_Worker.ps1" #-WindowStyle Hidden
